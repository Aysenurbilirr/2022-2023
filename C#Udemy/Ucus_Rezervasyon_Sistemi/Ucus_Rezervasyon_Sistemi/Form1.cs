...
namespace Ucus_Rezervasyon_Sistemi
{
    public partial class Form1 : Form
    {
        ...
        {
            label9.Text = comboBox2.Text;//Label9'un textine combobox2'yi yazdırdık.
            comboBox2.Text = comboBox1.Text;//combobox2'nin textine combobox1'in textini yazdırdık.
            comboBox1.Text = label9.Text;//combobox1'in textine label9'u yazdırdık.
        }
    }
}
